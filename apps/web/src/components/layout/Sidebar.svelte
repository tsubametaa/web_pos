...
>
            ...
            >
              ...
              <item.icon
                class="w-5 h-5 shrink-0 transition-transform duration-150 group-hover:scale-110
                  ...
                  : 'text-ink-muted group-hover:text-accent-soft-text'}"
              />
  ...
  <div
    class="p-3 border-t border-slate-200/60 dark:border-slate-800/60 bg-base/60 dark:bg-base/40"
  >
    {#if isCollapsed}
      ...
      <div class="hidden lg:flex items-center justify-center">
        ...
        >
          ...
          >
            ...
            <span class="text-[10px] font-normal text-rose-100"
      ...
      <div class="flex lg:hidden items-center justify-between gap-3">
        <div class="flex items-center gap-3 overflow-hidden">
          <div
            class="w-9 h-9 shrink-0 rounded-xl bg-accent text-white font-bold text-xs flex items-center justify-center shadow-xs ring-2 ring-accent/20"
          ...
          <div class="flex flex-col truncate">
            ...
            <span
              class="text-[10px] text-accent font-bold truncate flex items-center gap-1"
            >
              <Shield class="w-2.5 h-2.5 text-accent inline" />
