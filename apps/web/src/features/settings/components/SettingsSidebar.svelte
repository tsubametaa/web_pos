<script lang="ts">
	import { Store, ShieldCheck, Printer, Building2 } from 'lucide-svelte';

	export type TabType = 'profile' | 'security' | 'stores' | 'printer';
	...
	let { activeTab, isSuperAdmin = false, onTabChange }: Props = $props();
</script>
