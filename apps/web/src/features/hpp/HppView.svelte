        ...
        <table class="w-full text-xs">
          <thead>
            ...
            >
              ...
              <th
                class="text-right px-5 py-3.5 font-extrabold text-slate-500 dark:text-emerald-500/70 uppercase tracking-wider hidden sm:table-cell"
              >
                Margin %
              </th>
              <th
                class="text-right px-5 py-3.5 font-extrabold text-slate-500 dark:text-emerald-500/70 uppercase tracking-wider hidden md:table-cell"
              >
                Stok
              </th>
              <th
              ...
              <tr class="hover:bg-emerald-500/5 transition-colors">
                ...
                <td class="px-5 py-3.5">
                  <div class="flex items-center gap-3">
                    <div
                      class="w-9 h-9 rounded-xl bg-emerald-500/10 dark:bg-emerald-950/40 border border-slate-200/40 dark:border-emerald-950/60 overflow-hidden flex items-center justify-center shrink-0"
                    >
                      {#if p.imageUrl}
                        <img src={p.imageUrl} alt={p.name} class="w-full h-full object-cover" />
                      {:else}
                        <Package class="w-4 h-4 text-emerald-600 dark:text-emerald-400 stroke-[1.5]" />
                      {/if}
                    </div>
                    ...
                    <div class="flex flex-col min-w-0">
                      ...
                      <span class="text-[10px] font-mono font-medium text-slate-400 uppercase mt-0.5">
                        SKU: {p.sku || '-'}
                      </span>
                    </div>
                  </div>
